...
export PYTHONPATH=$INSTALLPATH/lib64/python2.7/site-packages:$PYTHONPATH
export PYTHONPATH=$INSTALLPATH/lib64/python2.7/heuristics:$PYTHONPATH
export PYTHONPATH=$INSTALLPATH/lib64/python2.7:$PYTHONPATH
...
site_packages = os.path.expanduser('~/.casa/lib/python2.7/site-packages')
